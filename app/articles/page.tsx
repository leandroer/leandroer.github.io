...
const articles = [
  ...
  { date: "03 JUL 2026", kind: "DETECTION", title: "What to log before your first AI incident", desc: "The minimum viable telemetry model for prompts, retrieval, policy decisions, tool execution, and human approvals.", time: "6 MIN", href: "#" },
  { date: "19 JUN 2026", kind: "PLAYBOOK", title: "Ransomware containment is a business decision", desc: "A decision framework for isolation when every option carries operational cost.", time: "7 MIN", href: "#" },
];
